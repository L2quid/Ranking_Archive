...
with open( filePath, 'w+',encoding='utf-8') as file:
    ...
    for i in range(20) :
        file.write('<div class="wrap"><div class="rank">'+str(i + 1) + '위</div> <div class="title">' + items[i].get_text(strip = True)+'</div><a class="link" href="'+str('https://news.naver.com')+links[2*i].attrs['href']+'"> 이동</a>'+'</div><br>')
